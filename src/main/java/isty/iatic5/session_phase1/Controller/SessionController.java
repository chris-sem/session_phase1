...
public class SessionController {
    ...
    private void gererSessionsButton() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/gestion-creneau-session-view.fxml"));
            Pane root = loader.load();

            // Récupérer le contrôleur associé
            GestionCreneauSessionController gestionCreneauSessionController = loader.getController();
